...
void run_echo(char copy_echo[]){
	char *t=strtok(copy_echo," ");
	t=strtok(NULL," ");
	if(t==NULL){
		// printf("xyz");
		printf("\n");
...
int main(int arg,char const *argc[]){
	...
	while(1){
		getcwd(currentDirectory,sizeof(currentDirectory));
		printf("[Udit]# %s ~$ ",currentDirectory);
		strcpy(copyPath,tmp);
		...
		if(strcmp(x[5],"cd")==0 || strcmp(x[5],"pwd")==0 || strcmp(x[5],"echo")==0){
			...
			if(strcmp(x[5],"ls")==0){
				...
				if(strcmp(x[0],"-a")==0 || strcmp(x[0],"-A")==0){
					if(strcmp(x[1],"&t")==0 ){
						x[1]=currentDirectory;
					}
				}
		...
		if(strcmp(x[5],"ls")==0 || strcmp(x[5],"cat")==0 || strcmp(x[5],"date")==0 || strcmp(x[5],"rm")==0 || strcmp(x[5],"mkdir")==0){
			...
			if(process_id==0){
				...
				else if(strcmp(x[5],"cat")==0){	
					execl(copyPath,copyPath,aasli,NULL);
					exit(0);
				}
				else if(strcmp(x[5],"rm")==0){
					
					execl(copyPath,copyPath,aasli,NULL);
					exit(0);
				}
				else if(strcmp(x[5],"date")==0){
					
					execl("./date.out","./date.out",x[0],x[1],x[2],NULL);
					exit(0);
				}
				else if(strcmp(x[5],"mkdir")==0){
